...
\subsection{Synthesis of \acac{Mn}}
...
\subsection{Measurement of Magnetic Moments}
...
summary of observations for each of the unknowns is tabulated below.

\tabcolsep=0.11cm
\begin{table}
\begin{tabular}{clcccccl}
\toprule
Unk.\ No.\ &           Color &  $m_\text{solid}$ (g) &  $m_\text{solvent}$ (g) &  $\Delta\nu$ (Hz) &   T (K) & $\mu_\text{calc}$ ($\mu_\text{B}$) & Assignment\\
\midrule
1 &        Green &      0.0226 &         1.240 &       0 &  293 & 0    & \acac{Co} \\
2 &       Violet &      0.0158 &         0.625 &     635 &  293 & 2.57 & \acac{Cr} \\
3 &      Crimson &      0.0154 &         0.306 &    1700 &  293 & 2.97 & \acac{V}  \\
